...
describe('Menus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'menus', component: MenusComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to menusService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMenusIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMenusIdentifier).toHaveBeenCalledWith(entity);
