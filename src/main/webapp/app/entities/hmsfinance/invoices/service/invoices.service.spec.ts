...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../invoices.test-samples';
...
describe('Invoices Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Invoices', () => {
      ...
      service.create(invoices).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Invoices', () => {
      ...
      service.update(invoices).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addInvoicesToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(invoices);
        expect(expectedResult).toContain(invoices2);
      });
