...
describe('Invoices Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'invoices', component: InvoicesComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to invoicesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInvoicesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInvoicesIdentifier).toHaveBeenCalledWith(entity);
