...
import { EntityArrayResponseType, InvoicesService } from '../service/invoices.service';
...
export class InvoicesComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInvoices): number => this.invoicesService.getInvoicesIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IInvoices[] | null): IInvoices[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.invoicesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
