...
import { EntityArrayResponseType, InvoiceDetailsService } from '../service/invoice-details.service';
...
export class InvoiceDetailsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInvoiceDetails): number => this.invoiceDetailsService.getInvoiceDetailsIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.invoiceDetails = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IInvoiceDetails[] | null): IInvoiceDetails[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.invoiceDetailsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
